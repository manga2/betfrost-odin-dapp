                                                    ...
                                                    <Row className="d-flex justify-content-center">
                                                        <Col className="mt-3" xs="6" sm="3">
                                                            <div className="d-flex flex-column">
                                                                ...
                                                                <span className="mt-2">{lotteries && lotteries[selectedClaimableRoundIndex].reward_percentage_per_bracket[0]} %</span>
                                                        ...
                                                        <Col className="mt-3" xs="6" sm="3">
                                                            <div className="d-flex flex-column">
                                                                ...
                                                                <span className="mt-2">{lotteries && lotteries[selectedClaimableRoundIndex].reward_percentage_per_bracket[1]} %</span>
                                                        ...
                                                        <Col className="mt-3" xs="6" sm="3">
                                                            <div className="d-flex flex-column">
                                                                ...
                                                                <span className="mt-2">{lotteries && lotteries[selectedClaimableRoundIndex].reward_percentage_per_bracket[2]} %</span>
                                                        ...
                                                        <Col className="mt-3" xs="6" sm="3">
                                                            <div className="d-flex flex-column">
                                                                ...
                                                                <span className="mt-2">{lotteries && lotteries[selectedClaimableRoundIndex].reward_percentage_per_bracket[3]} %</span>
